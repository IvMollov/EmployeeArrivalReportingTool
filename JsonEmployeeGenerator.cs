...
namespace JsonEmployeeGenerator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //This operation should be in try/catch block because there is data reading from file. And moved to a method.
            ...
            //This operation should be in try/catch block because there is data writing in file. And moved to a method.
            var jsonFile = File.CreateText("employees.json");
            jsonFile.WriteLine("[");

            //For this operation should be used StringBuilder. Now, the code is pretty hard to read.
    ...
    //This class should be moved to separate file.
